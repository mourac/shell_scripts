# spec file for html files of the www.storagekirayi.com site

Name:           PAY_rp_storagekirayi
Version:        %(../rpm_version)
Release:        %(../rpm_release)
License:        YapStone
Summary:        YapStone storagekirayi.com html
...
%define destroot     /srv/data/content/storagekirayi.com
...
rm -rf ${my_root}
mkdir -p ${my_root}
cp -r %{baseDir}/domestic/storagekirayi.com-current/* ${my_root}/
