# spec file for html files of the www.myinnpayment.com site

Name:           PAY_rp_innpayment
Version:        %(../rpm_version)
Release:        %(../rpm_release)
License:        MyCompany
Summary:        MyCompany innpayment.com html
...
%define destroot     /srv/data/content/innpayment.com
...
rm -rf ${my_root}
mkdir -p ${my_root}
cp -r %{baseDir}/domestic/innpayment.com/* ${my_root}/
