# spec file for html files of the www.dues.com site

Name:           PAY_rp_duespayment
Version:        %(../rpm_version)
Release:        %(../rpm_release)
License:        MyCompany
Summary:        MyCompany dues.com html
...
%define destroot     /srv/data/content/dues.com
...
rm -rf ${my_root}
mkdir -p ${my_root}
cp -r %{baseDir}/domestic/dues.com-current/* ${my_root}/
