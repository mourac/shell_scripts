# spec file for html files of the www.kirayi.com site

Name:           PAY_pr_domestic
Version:        %(../rpm_version)
Release:        %(../rpm_release)
License:        MyCompany
Summary:        MyCompany kirayi.com html
...
%define destroot     /srv/data/content/kirayi.com-current
...
rm -rf ${my_root}
mkdir -p ${my_root}
cp -r %{baseDir}/domestic/kirayi.com-current/* ${my_root}/
