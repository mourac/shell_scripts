# spec file for html files of the www.r_paymentmanagement.com site

Name:           PAY_rp_rentalpaymentmanagement
Version:        %(../rpm_version)
Release:        %(../rpm_release)
License:        MyCompany
Summary:        MyCompany r_paymentmanagement.com html
...
%define destroot     /srv/data/content/r_paymentmanagement.com
...
rm -rf ${my_root}
mkdir -p ${my_root}
cp -r %{baseDir}/domestic/r_paymentmanagement.com/* ${my_root}/
